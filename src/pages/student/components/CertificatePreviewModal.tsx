      ...
      >
        ...
        <div className="p-6 space-y-4">
          <div className="text-center">
            ...
            <h3 className="text-lg font-heading font-black text-[#00271D] mt-2">{certificate.name}</h3>
            <p className="text-[11px] text-[#00271D]/50 font-medium mt-0.5">{meta.blurb}</p>
          </div>

          <div className="grid grid-cols-2 gap-2 text-[11px]">
            <div className="p-3 rounded-xl bg-[#F9F3F0] border border-[#00271D]/10">
              <p className="text-[9px] font-bold uppercase tracking-wider text-[#00271D]/40">Eco-Points</p>
              <p className="font-extrabold text-[#00A77C] mt-0.5">{certificate.pointsAtIssue} pts</p>
            </div>
            <div className="p-3 rounded-xl bg-[#F9F3F0] border border-[#00271D]/10">
              <p className="text-[9px] font-bold uppercase tracking-wider text-[#00271D]/40">
                {certificate.type === 'RANK' ? 'Final Rank' : 'Award Type'}
              </p>
              <p className="font-extrabold text-[#C69B26] mt-0.5">
                {certificate.type === 'RANK' ? `Rank #${certificate.rankAtIssue ?? '-'}` : 'Milestone'}
              </p>
            </div>
          </div>

          <div className="space-y-1.5 text-[11px] text-[#00271D]/70">
            {certificate.termName && (
              <p className="flex items-center gap-1.5">
                <Calendar size={12} className="text-[#00271D]/40" />
                {certificate.termName}
            ...
            <p className="flex items-center gap-1.5 font-mono text-[10px] text-[#00271D]/50">
              <Hash size={12} className="text-[#00271D]/40" />
              {certificate.serial}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 pt-1">
            {onView && (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#00A77C]/10 border border-[#00A77C]/25 text-[#00A77C] text-xs font-bold hover:bg-[#00A77C]/20 transition-colors cursor-pointer"
              >
                <Eye size={14} />
                Open PDF
              </button>
            ...
            {onDownload && (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#C69B26] text-white text-xs font-bold hover:bg-[#b38a20] transition-colors cursor-pointer disabled:opacity-50"
              >
                <Download size={14} />
                Download
              </button>
