      ...
      <div className="bg-white/95 backdrop-blur-md border border-white/80 rounded-3xl p-8 shadow-xl text-center space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            <div>
              ...
              <span className="font-bold text-[var(--text-strong)] flex items-center gap-1 mt-0.5">
                <Package size={13} className="text-[var(--accent)]" /> {lastSubmittedReport?.title || reportTitle || 'Recyclable'}
              </span>
            </div>
            ...
            <div>
              ...
              <span className="font-bold text-[var(--text-strong)] flex items-center gap-1 mt-0.5">
                <MapPin size={13} className="text-[var(--accent)]" /> {lastSubmittedReport?.location || locationName || 'Campus Station'}
              </span>
            </div>
            ...
            <div>
              ...
              <span className="font-bold text-[var(--text-strong)] flex items-center gap-1 mt-0.5">
                <AlertTriangle size={13} className={(lastSubmittedReport?.urgency || urgency) === 'HIGH' ? 'text-rose-500' : 'text-[var(--accent)]'} />
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          <button
            type="button"
            onClick={onReset}
            className="flex-1 py-3.5 px-5 rounded-2xl bg-[var(--accent)] hover:bg-[var(--accent-dark)] text-white font-bold text-xs shadow-md transition-all cursor-pointer flex items-center justify-center gap-2"
          >
            <Send size={15} />
