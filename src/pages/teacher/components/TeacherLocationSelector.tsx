      ...
      <div className="space-y-3">
        {isWasteCategory && (
          <>
            ...
            >
              {blueprintUrl ? (
                <img src={blueprintUrl} alt="Custom Campus Map Blueprint" className="absolute inset-0 w-full h-full object-cover opacity-75 pointer-events-none" />
