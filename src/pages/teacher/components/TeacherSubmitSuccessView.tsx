      ...
      <div className="bg-white/95 backdrop-blur-md border border-white/80 rounded-3xl p-8 shadow-xl text-center space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            <div>
              ...
              <span className="font-bold text-[#00271D] flex items-center gap-1 mt-0.5">
                <Package size={13} className="text-[#00A77C]" /> {lastSubmittedReport?.title || 'Maintenance Request'}
              </span>
            </div>
            ...
            <div>
              ...
              <span className="font-bold text-[#00271D] flex items-center gap-1 mt-0.5">
                <MapPin size={13} className="text-[#00A77C]" /> {lastSubmittedReport?.location || 'Campus'}
              </span>
            </div>
            ...
            <div>
              ...
              <span className="font-bold text-[#00271D] flex items-center gap-1 mt-0.5">
                <AlertTriangle size={13} className={lastSubmittedReport?.urgency === 'HIGH' ? 'text-rose-500' : 'text-[#00A77C]'} />
            ...
            {!isWaste && lastSubmittedReport?.observation && (
              <div>
                <span className="text-[#00271D]/50 font-medium block text-[10px]">Asset Condition</span>
                <span className="font-bold text-[#00271D] flex items-center gap-1 mt-0.5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          <button
            type="button"
            onClick={onReset}
            className="flex-1 py-3.5 px-5 rounded-2xl bg-[#00A77C] text-white font-bold text-xs shadow-md hover:bg-[#008f6a] transition-all cursor-pointer flex items-center justify-center gap-2"
          >
            <Send size={15} />
