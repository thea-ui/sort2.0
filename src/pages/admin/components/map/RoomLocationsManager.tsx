  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2.5 pt-1">
    {roomList.map((roomName, idx) => (
      <div
        ...
        className="p-3 bg-[#F9F3F0] rounded-2xl flex items-center justify-between text-xs border border-gray-200/60 hover:border-[#00A77C]/40 transition-colors"
      >
  ...
  return (
    ...
    >
      ...
      <details
        ...
        className="border border-gray-200/70 rounded-2xl bg-[#F9F3F0]/40 group"
      >
        <summary className="cursor-pointer select-none px-4 py-3 text-xs font-bold text-[#00271D]/70 flex items-center gap-2 list-none">
          <ChevronDown size={13} className="text-[#00271D]/40 transition-transform group-open:rotate-180" />
