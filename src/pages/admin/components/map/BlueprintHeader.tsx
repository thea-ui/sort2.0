...
import { Building2, Upload, Move, Plus, CheckCircle2, AlertTriangle } from 'lucide-react';
...
export const BlueprintHeader: React.FC<BlueprintHeaderProps> = ({
  ...
  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/90 backdrop-blur-md border border-white/80 rounded-3xl p-6 shadow-sm">
    <div>
      ...
      <p className="text-xs text-[#00271D]/50 mt-1">
        Upload map blueprints, drag-and-drop bin coordinates, and toggle availability for each waste stream per station.
      </p>
