...
export const AdminReportsTab: React.FC<AdminReportsTabProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12 animate-fade-in">
      ...
      {feedbackMsg && (
        <div className="fixed top-20 left-4 right-4 sm:left-auto sm:right-6 z-[9999] bg-[#00271D] text-white px-5 py-4 rounded-2xl shadow-2xl border-2 border-[#00A77C] flex items-center gap-3 animate-fade-in max-w-sm sm:ml-auto">
