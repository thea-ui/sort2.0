  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: 'var(--background)' }}>
      ...
      <div className="w-full max-w-sm z-10 space-y-4">
        ...
        <div className="bg-white/90 backdrop-blur-xl border border-white/80 rounded-3xl p-6 shadow-xl shadow-[var(--primary)]/5">
          <div className="text-center space-y-2 mb-6">
            ...
            <SortLogo size={32} />
            <div>
              <h2 className="text-base font-black tracking-tight text-[var(--text-strong)] mt-1">MRF Terminal</h2>
          ...
          <form onSubmit={handleMRFSubmit} className="space-y-4 text-xs">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-[var(--primary)]/10 bg-[var(--background)]/60 text-xs text-[var(--text-strong)] outline-none focus:border-[var(--accent)] focus:bg-white transition-all"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 pr-10 rounded-xl border border-[var(--primary)]/10 bg-[var(--background)]/60 text-xs text-[var(--text-strong)] outline-none focus:border-[var(--accent)] focus:bg-white transition-all"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-3 text-white font-black text-xs uppercase tracking-wider rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-1.5 shadow-lg shadow-[var(--accent)]/20"
              style={{ background: 'linear-gradient(135deg, var(--accent), var(--accent-light))' }}
            >
              {loading ? (
                <>
